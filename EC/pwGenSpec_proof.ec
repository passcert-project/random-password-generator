...
(* passCertPasswordGenerator terminates *)
lemma termination length lowercase_min lowercase_max uppercase_min uppercase_max numbers_min
    numbers_max special_min special_max &m :
Pr[Termination.main(length, lowercase_min, lowercase_max, uppercase_min, uppercase_max,
