...
module M = {
  ...
  proc generatePw (length:W64.t, lowercase_policies:W64.t,
                   ...
                   special_policies:W64.t, p_output:W64.t) : unit = {
      ...
      if ((tmp64_1 \ule length)) {
        ...
        if ((length \ule tmp64_1)) {
          ...
          while ((i \ult (W64.of_int 76))) {
            lowercase_set.[(W64.to_uint i)] <- (W8.of_int 0);
            i <- (i + (W64.of_int 1));
          }
          ...
          while ((i \ult (W64.of_int 76))) {
            uppercase_set.[(W64.to_uint i)] <- (W8.of_int 0);
            i <- (i + (W64.of_int 1));
          }
          ...
          if ((lowercase_available = (W64.of_int 1))) {
            ...
            while ((i \ult lowercase_min)) {
              tmp8 <@ random_char_generator ((W64.of_int 26), lowercase_set);
              Glob.mem <-
          ...
          if ((uppercase_available = (W64.of_int 1))) {
            ...
            while ((i \ult uppercase_min)) {
              tmp8 <@ random_char_generator ((W64.of_int 26), uppercase_set);
              Glob.mem <-
              storeW8 Glob.mem (W64.to_uint (p_output + i_filled)) tmp8;
              i <- (i + (W64.of_int 1));
              i_filled <- (i_filled + (W64.of_int 1));
          ...
          if ((numbers_available = (W64.of_int 1))) {
            ...
            while ((i \ult numbers_min)) {
              tmp8 <@ random_char_generator ((W64.of_int 10), numbers_set);
              Glob.mem <-
              storeW8 Glob.mem (W64.to_uint (p_output + i_filled)) tmp8;
              i <- (i + (W64.of_int 1));
              i_filled <- (i_filled + (W64.of_int 1));
          ...
          if ((special_available = (W64.of_int 1))) {
            ...
            while ((i \ult special_min)) {
              tmp8 <@ random_char_generator ((W64.of_int 14), special_set);
              Glob.mem <-
              storeW8 Glob.mem (W64.to_uint (p_output + i_filled)) tmp8;
              i <- (i + (W64.of_int 1));
              i_filled <- (i_filled + (W64.of_int 1));
          ...
          (tmp64_1, union_set) <@ define_union_set (lowercase_available,
          uppercase_available, numbers_available, special_available,
          ...
          while ((i_filled \ult length)) {
            ...
            if (((W8.of_int 97) \ule tmp8)) {
              if ((tmp8 \ule (W8.of_int 122))) {
                lowercase_max <- (lowercase_max - (W64.of_int 1));
                if ((lowercase_max = (W64.of_int 0))) {
                  lowercase_available <- (W64.of_int 0);
                  (tmp64_1,
                  union_set) <@ define_union_set (lowercase_available,
                  uppercase_available, numbers_available, special_available,
                  lowercase_set, uppercase_set, numbers_set, special_set,
                  union_set);
                } else {
              ...
              if (((W8.of_int 65) \ule tmp8)) {
                if ((tmp8 \ule (W8.of_int 90))) {
                  uppercase_max <- (uppercase_max - (W64.of_int 1));
                  if ((uppercase_max = (W64.of_int 0))) {
                    uppercase_available <- (W64.of_int 0);
                    (tmp64_1,
                    union_set) <@ define_union_set (lowercase_available,
                    uppercase_available, numbers_available,
                    special_available, lowercase_set, uppercase_set,
                ...
                if (((W8.of_int 48) \ule tmp8)) {
                  if ((tmp8 \ule (W8.of_int 57))) {
                    numbers_max <- (numbers_max - (W64.of_int 1));
                    if ((numbers_max = (W64.of_int 0))) {
                      numbers_available <- (W64.of_int 0);
                      (tmp64_1,
                      union_set) <@ define_union_set (lowercase_available,
                      uppercase_available, numbers_available,
                      special_available, lowercase_set, uppercase_set,
                  ...
                  special_max <- (special_max - (W64.of_int 1));
                  if ((special_max = (W64.of_int 0))) {
                    special_available <- (W64.of_int 0);
                    (tmp64_1,
                    union_set) <@ define_union_set (lowercase_available,
                    uppercase_available, numbers_available,
                    special_available, lowercase_set, uppercase_set,
            ...
            Glob.mem <- storeW8 Glob.mem (W64.to_uint (p_output + i)) tmp8;
            i_filled <- (i_filled + (W64.of_int 1));
          }
          ...
          Glob.mem <-
          storeW64 Glob.mem (W64.to_uint (p_output + (W64.of_int 0))) (W64.of_int 3);
          Glob.mem <-
          storeW64 Glob.mem (W64.to_uint (p_output + (W64.of_int 1))) (W64.of_int 0);
        }
      } else {
        Glob.mem <-
        storeW64 Glob.mem (W64.to_uint (p_output + (W64.of_int 0))) (W64.of_int 2);
        Glob.mem <-
        storeW64 Glob.mem (W64.to_uint (p_output + (W64.of_int 1))) (W64.of_int 0);
      }
    } else {
      Glob.mem <-
      storeW64 Glob.mem (W64.to_uint (p_output + (W64.of_int 0))) (W64.of_int 1);
      Glob.mem <-
      storeW64 Glob.mem (W64.to_uint (p_output + (W64.of_int 1))) (W64.of_int 0);
    }
    return ();
